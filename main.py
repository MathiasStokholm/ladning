"""
Example code for integrating VehicleState with your application:

In your application class, add this method:
...
if __name__ == "__main__":
    print("This is an example file showing how to integrate VehicleState.")
    print("See the docstring at the top of this file for usage examples.")
